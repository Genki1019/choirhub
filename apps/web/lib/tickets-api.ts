...
export const ticketsApi = {
  list: (orgSlug: string) => apiClient.get<TicketConcertSummary[]>(`/${orgSlug}/tickets`),
  ...
  updateBatch: (orgSlug: string, concertId: string, batchId: string, data: UpdateBatchInput) =>
    apiClient.patch<Omit<BatchDetail, "allocations">>(
      `/${orgSlug}/tickets/${concertId}/batches/${batchId}`,
      data,
    ),
  ...
  publishRace: (orgSlug: string, concertId: string) =>
    apiClient.post<{ racePublishedAt: string | null }>(
      `/${orgSlug}/tickets/${concertId}/race/publish`,
      {},
    ),
  ...
  closeTicketInput: (orgSlug: string, concertId: string) =>
    apiClient.post<{ ticketInputClosedAt: string | null }>(
      `/${orgSlug}/tickets/${concertId}/close`,
      {},
    ),
  ...
  setOutreachExpenseRate: (
    orgSlug: string,
    concertId: string,
    outreachExpensePerTrip: number | null,
  ) =>
    apiClient.patch<{ outreachExpensePerTrip: number | null }>(
      `/${orgSlug}/tickets/${concertId}/outreach-expense-rate`,
      { outreachExpensePerTrip },
    ),
  ...
  bulkOutreachExpense: (
    ...
    apiClient.post<{ updatedCount: number }>(
      `/${orgSlug}/tickets/${concertId}/outreach-expenses/bulk`,
      { allocationIds, paid },
    ),
  ...
  payOutreachActivity: (orgSlug: string, concertId: string, activityId: string) =>
    apiClient.patch<OutreachActivityRow>(

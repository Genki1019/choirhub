...
| 見学申込Webhook設定              | `/[org]/settings/visitor-webhook`              | admin                                                                              |
...
- 「テキストをコピーする」→ 紹介文をクリップボードにコピーする（他のメール文面に貼り付けて利用する想定）
...
### 12.7 見学申込Webhook `/[org]/settings/visitor-webhook`（admin）

**目的**: Googleフォーム連携用のWebhook URL・トークンを発行・再発行する
